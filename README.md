...
**🎯 在线试玩**（现可直接打开）：
https://raw.githubusercontent.com/CloudD67/pixel-hero-endless-halls/main/pixel-hero.html

开启 GitHub Pages 后访问仓库主页，根路径会自动跳转到游戏。

## ✨ 特性

- **单文件零依赖**：无 CDN、无图片、无音频、无字体，全部内嵌
- **像素手绘风**：所有精灵用「字符串数组 + 调色板」程序化绘制，16×16 像素格
...
404.html             GitHub Pages 根路径跳转页（可选）
LICENSE              MIT 协议
